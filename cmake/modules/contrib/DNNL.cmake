...
if((USE_DNNL_CODEGEN STREQUAL "ON") OR (USE_DNNL_CODEGEN STREQUAL "JSON"))
  target_compile_definitions(tvm_deps INTERFACE USE_JSON_RUNTIME=1)
  file(GLOB DNNL_RELAY_CONTRIB_SRC src/relay/backend/contrib/dnnl/*.cc)
  target_sources(tvm_objs PRIVATE ${DNNL_RELAY_CONTRIB_SRC})
  target_sources(tvm_objs PRIVATE ${JSON_RELAY_CONTRIB_SRC})

  find_library(EXTERN_LIBRARY_DNNL dnnl)
  target_link_libraries(tvm_runtime_objs PRIVATE ${EXTERN_LIBRARY_DNNL})
  file(GLOB DNNL_CONTRIB_SRC src/runtime/contrib/dnnl/dnnl_json_runtime.cc)
  target_sources(tvm_runtime_objs PRIVATE ${DNNL_CONTRIB_SRC})
