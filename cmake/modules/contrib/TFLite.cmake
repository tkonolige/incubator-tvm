...
if(NOT USE_TFLITE STREQUAL "OFF")
  ...
  target_sources(tvm_runtime_objs PRIVATE ${TFLITE_CONTRIB_SRC})
  target_include_directories(tvm_deps INTERFACE ${USE_TENSORFLOW_PATH})
  ...
  if (NOT USE_EDGETPU STREQUAL "OFF")
    ...
    target_sources(tvm_runtime_objs PRIVATE ${EDGETPU_CONTRIB_SRC})
    target_include_directories(tvm_deps INTERFACE ${USE_EDGETPU}/libedgetpu)
    target_link_libraries(tvm_runtime_objs PRIVATE ${USE_EDGETPU}/libedgetpu/direct/aarch64/libedgetpu.so.1)
  endif()
  ...
  if (NOT USE_FLATBUFFERS_PATH STREQUAL "none")
    target_include_directories(tvm_deps INTERFACE ${USE_FLATBUFFERS_PATH}/include)
  endif()
endif()
