...
inline tvm::te::Tensor binarize_pack(const tvm::te::Tensor& data, int axis,
  ...
  TVM_ICHECK_EQ(GetConstInt(ishape[axis]) % 32, 0)
...
inline tvm::te::Tensor binary_dense(const tvm::te::Tensor& data, const tvm::te::Tensor& weight) {
  TVM_ICHECK_EQ(data->shape.size(), 2) << "binary_dense requires 2-D data";
  TVM_ICHECK_EQ(weight->shape.size(), 2) << "binary_dense requires 2-D weight";
  TVM_ICHECK_EQ(data->dtype, DataType::UInt(32)) << "binary_dense requires uint32 data";
  TVM_ICHECK_EQ(weight->dtype, DataType::UInt(32)) << "binary_dense requires uint32 weight";
